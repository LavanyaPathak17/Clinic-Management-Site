          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Navbar Management</h3>
                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <a href = "nav-update-form.php?id=<?php echo $user['id']; ?>" class="btn btn-warning btn-sm"> Update </a>
                       
                        <form action="nav_links.php" method="POST" style="display:inline;">
